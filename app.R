...
.layout-fixed.sidebar-mini.sidebar-collapse .wrapper .main-sidebar.sidebar-dark-primary.elevation-4.shiny-bound-input .brand-link .logo-content{
  ...
  height: 50px;
  left: 25px;
  background: url('https://avatars.githubusercontent.com/u/112302277?s=400&u=cbd35fa32b91217fb520bde438550648ea09cf7c&v=4');
  ...
  body = dashboardBody(
    tabItems(
      ...
      tabItem("general",
              ...
              box(
                title = " Cardiovascular disease mortality by sex, age and causes",
                solidHeader = TRUE,
                status = "primary",
              ...
              box(
                title = " Trends in cardiovascular disease mortality between 2010 and 2020",
                solidHeader = TRUE,
                status = "warning",
              ...
              box(title = " Cardiovascular disease mortality by province",
                  solidHeader = TRUE,
                  status = "danger",
      ...
      tabItem("changes",
              box(
                title = "Annualised rate of change in cardiovascular disease mortality by sex  2010-2020",
                solidHeader = TRUE,
                status = "lightblue",
              ...
              box(
                title = "Annualised rate of change in cardiovascular disease mortality by province 2010-2020",
                solidHeader = TRUE,
                status = "indigo",
                icon = icon("transfer", lib = "glyphicon"),
                width = 11.5,
...
server <- function(input, output, session){
  ...
  output$plot1 <- renderEcharts4r({
    if(input$medida1=="Total"){
      db %>% 
        ...
        e_title("Cardiovascular disease mortality by cause, age and sex 2010-2020",
      ...
      db %>% 
        ...
        e_bar(Rate) %>% 
        e_color(color = c("#FD7E14", "#6F42C1", "#007BFF")) %>% 
        e_title(text = "Cardiovascular disease mortality by cause, age and sex 2010-2020",
  ...
  output$plot0 <- renderEcharts4r({
    if(input$medida0=="Total"){
      trends_table() %>% 
        ...
        e_line(N) %>% 
        e_color(color = c("#FD7E14", "#6F42C1", "#007BFF")) %>%
        e_title("Trends in cardiovascular diseases mortality by cause, age and sex 2010-2020",
                "Data extracted from the Statistical Yearbook on Health 2010-2020") %>% 
  ...
  output$map <- renderEcharts4r({
    provincias %>% 
      ...
      e_title("Cardiovascular disease mortality in Cuba by province 2010-2020",
              "Data extracted from the Statistical Yearbook on Health 2010-2020") %>% 
      e_show_loading()
  })
  ...
  output$plot3 <- renderEcharts4r({
    acr_province %>% 
      ...
      e_title("Annualised rate of change in cardiovascular disease mortality by province 2010-2020",
              "Data extracted from the Statistical Yearbook on Health 2010-2020") %>% 
      e_labels() %>% 
      e_show_loading()
  })
